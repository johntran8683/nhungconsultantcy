  ...
  const contactMethods = [
    {
      icon: Mail,
      title: 'Email',
      value: 'nhungnt102@gmail.com',
      description: 'Response within 24 hours'
    },
    {
      icon: Phone,
      title: 'Phone',
      value: '+1-672-999-7979',
      ...
      <section className="section-padding bg-white relative">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {faqs.map((faq, index) => (
              <div key={index} className="group">
                <div className="p-8 bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
              ...
              <a href="mailto:nhungnt102@gmail.com" className="group bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-white hover:text-blue-600 hover:scale-105 transition-all duration-300">
                Send Email
              </a>
            </div>
